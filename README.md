...
2. docker, az cli, kubectlのインストール  
    ...
    ```
    バージョンが開きすぎていると警告が出ますのでバージョン指定してcliをインストールします。

    az aks install-cli --client-version 1.33.7
...
aks-arbiter-28305043-vmss000000     Ready    <none>   14m   v1.33.7
aks-iris-16169790-vmss000000        Ready    <none>   17m   v1.33.7
aks-iris-16169790-vmss000001        Ready    <none>   17m   v1.33.7
aks-nodepool1-12214177-vmss000000   Ready    <none>   19m   v1.33.7
```
